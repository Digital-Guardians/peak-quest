...
import KakaoMapLineAlready from "../course/KakaoMapLineAlready";
    ...
    <div>
      <div className="fixed top-0 z-10 mx-auto flex h-screen w-full max-w-[430px] items-center justify-center bg-black/60">
        <div className="flex w-[85%] max-w-[430px] flex-col items-center justify-center rounded-lg bg-white px-2 py-3 shadow-3xl  sm:w-[93%]">
          ...
          <div className="mb-2 mt-2 h-[400px] w-[300px] text-black underline ">
            <a
            ...
            <div className="mt-5 h-[350px] w-[300px]">
              <KakaoMapLineAlready selectOriginCourse={selectOriginCourse} />
            </div>
          </div>
          <div className="mb-2 mt-2 flex h-[40px] w-full items-center justify-evenly text-md">
            <button
