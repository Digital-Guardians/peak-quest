...
export default function MyCourseTitle({ handleMyCourseTitle }: MyCourseTitleProps) {
  return (
    <div>
      <div className="flex items-center justify-between">
        <h1 className="mb-2 text-xl font-medium text-black">나만의 코스 제목</h1>
        <p className="bg-lightGreen p-1 text-md leading-3 text-green">20글자 입력 가능</p>
      </div>
      <input
